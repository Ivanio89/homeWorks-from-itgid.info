...
let check = new Valid("user", "12345");
check.validate();
...
let check2 = new Valid("user", "1234567");
check2.validate();
...
let valid3 = new Valid2("intellegentnii_huligan@mail.com", "123456789", "");
valid3.validate();
console.log(valid3);
