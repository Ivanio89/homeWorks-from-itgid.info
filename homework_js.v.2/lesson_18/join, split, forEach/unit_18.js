...
function t5() {
    ...
    document.querySelectorAll(".task-5").forEach(elem => {
        elem = this.getAttribute("data");
        answer = elem;
    })
    a5_res.push(answer);
    return document.querySelector(".out-5").innerHTML = a5_res;
}
...
function t7() {
    let str7 = 'hello world hi mazai'.split(" ");
    // str7.split(" ");
    let seven = str7.forEach(elem => {
        a7_res.push(elem.trim());
    })
